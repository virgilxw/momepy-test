...
from libpysal.weights._contW_lists import ContiguityWeightsLists
from libpysal.weights.util import get_ids, get_points_array
from libpysal.weights.raster import da2W, da2WSP

try:
    from shapely.geometry import Point as shapely_point
    from libpysal.cg.shapes import Point as pysal_point

    point_type = (shapely_point, pysal_point)
except ImportError:
    from libpysal.cg.shapes import Point as point_type
